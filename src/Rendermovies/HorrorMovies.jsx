...
export default function HorrorMovies() {
   ...
   const handleCardLeave = () => {
     ...
     useEffect(() => {
                const fnc = async () => {
                  const res = await fetch(`https://api.themoviedb.org/3/discover/movie?api_key=${API_KEY}&with_genres=27`)
    
                  const data = await res.json();
                  console.log("Horror",data); // data.results is the array
              ...
              return (
                <div className="carousel-container">
                  ...
                  <div className="carousel-wrapper">
                    ...
                    <span className="carousel-title ">Horror Movies</span>
                    
                    <div className="carousel-cards">
                      {Horromovies? Horromovies.map((comic,index) => (
